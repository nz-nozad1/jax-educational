...
import '../styles/books2.css'
console.log("🔥 JAX Acode Connected");
const cards = [
  { icon: '/b1.png', title: 'هندسه وحاسبات', text: 'كتب الوزارة مسار هندسه وحاسبات', new: true },
  { icon: '/b2.png', title: 'طب وعلوم الحياه', text: 'كتب الوزارة مسار طب وعلوم الحياه', new: true },
  { icon: '/b3.png', title: 'اداب وفنون', text: 'كتب الوزارة مسار اداب وفنون', new: true },
  { icon: '/b4.png', title: 'ادارة اعمال', text: 'كتب الوزارة مسار ادارة الاعمال', new: true },
]

  function Books2({ onBackHome, onGoHome, onOpenEngineering }) {
  ...
  return (
    <div
      className={`Books2-page ${darkMode ? 'dark-mode' : ''}`}
      dir="rtl"
    >
...
<span className="back-arrow">↩︎</span>
  ...
  setSelectedCard(index);
            ...
            >
              ...
              <span className="new-badge books2-bac-badge">
  Bac2
</span>
