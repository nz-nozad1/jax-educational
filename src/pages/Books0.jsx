...
import '../styles/books0.css'
console.log("🔥 JAX Acode Connected");
const cards = [
  { icon: '/b12.png', title: 'بكالوريا', text: 'كتب نظام البكالوريا المصريه', new: true },
  { icon: '/b10.png', title: 'الثانويه العامه', text: 'كتب نظام الثانوي العام', locked: true },
]

  function Books0({ onBackHome, onOpenBooks }) {
  ...
  const interval = setInterval(() => {
    setProfileImage(profileImage + 1 > 4 ? 1 : profileImage + 1)
  }, 2000)
  ...
  return (
    <div
      className={`Books0-page ${darkMode ? 'dark-mode' : ''}`}
      dir="rtl"
    >
...
{card.new && <span className="new-badge">BAC</span>}
              
{card.locked && <span className="lock-badge">HSD</span>}
